import { AspectRatio, Box, HStack, Stack } from '@chakra-ui/react'
...
const Footer = () => {
  ...
  return (
    <Box bg={'#232222'}  py={'20px'}  id='contact' >
      ...
      //  h={{base:"230px",sm:"200px",md:"285px",lg:"270px",xl:"280px","2xl":"400px"}}  
       fontSize={{base:"sm",md:"md"}}
        ...
        <Stack  direction={'column'}  border={boder2} borderColor={'white'}  w={{base:"100%",md:'500px'}} justifyContent={'space-between'}  >
          <Box w={'80%'} h={{md:"250",lg:"270px",xl:"215px",xl:"250px","2xl":"280px"}} backgroundColor={'gray.700'} m={{base:0,lg:'auto'}} borderRadius={'10px'}  display={{base:'none',md:"block",lg:'block'}} >
