...
const GalleryRight = ({location,brochure}) => {
  return (
    <Stack direction={'column'} gap={'30px'}  justify={'center'} align={{base:'center',lg:"center",xl:"baseline"}}  border={'0px'} borderColor={'white'} >
        {
          brochure === 'none'?null:<Center w={{base:"70%",md:"50%",lg:'300px',"2xl":"363px"}} h={{base:"50px",lg:'70px',"2xl":"79x"}}   bg='#393939' borderRadius={'20px'} cursor={'pointer'} mt={'20px'} _hover={{color:"black",bg:'#FCD160'}} >
