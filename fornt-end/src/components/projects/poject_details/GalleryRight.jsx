...
const GalleryRight = ({location}) => {
  return (
    <Stack direction={'column'} gap={'30px'}  justify={'center'} align={{base:'center',lg:"center",xl:"baseline"}} >
        <Center w={{base:"70%",md:"50%",lg:'300px'}} h={{base:"50px",lg:'70px'}}  bg={'#FCD160'}  borderRadius={'20px'} cursor={'pointer'} mt={'20px'} _hover={{color:"black"}} >
            <Text fontSize={{base:"15px",md:"20px"}}  >Download Brochure</Text>
        </Center>
        <HStack w={{base:"100%",lg:'80%',xl:"502px"}} cursor={'pointer'} >
